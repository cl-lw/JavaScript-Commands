 ...
 **These perform a task to produce a related output, including Outputting Data and Global Functions.**
   ...
   **These occur until certain conditions are met.**
   ...
   ______________________________________________________________________________________________________________
      ...
      while  `  Sets up conditions for a loop  ` 

   ______________________________________________________________________________________________________________
   
      do-while    ` Checks once again to see if the conditions are met ` 

   ______________________________________________________________________________________________________________
   
      break   `  Stops the loop cycle if conditions aren’t me  ` 

   ______________________________________________________________________________________________________________

      continue   ` Skip parts of the loop if conditions are met  ` 
   ...
   **Skip parts of the loop if conditions are met**
   ...
   ______________________________________________________________________________________________________________
      ...
      if (condition) {//}   ` If a condition is met do this  ` 

   ______________________________________________________________________________________________________________

      } else {//}   ` If a condition is not met do this  ` 
